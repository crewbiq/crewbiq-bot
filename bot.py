"""
CrewBIQ Support Bot v1.0
CrewBIQ LLC

Умный Telegram бот для поддержки пользователей CrewBIQ Driver.
...
Key facts:
- App URL: crewbiq-dev.github.io/crewbiq-driver
...
async def cmd_feedback(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        "💬 *General Feedback*\n\nWhat's on your mind? Tell me anything about CrewBIQ Driver.",
        parse_mode="Markdown"
    )
...
def main():
    ...
    log.info("CrewBIQ Support Bot starting...")
